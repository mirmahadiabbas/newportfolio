...
const SITE = {
  ...
  hero: {
    ...
    docStrip: [
      ...
      { k: "Focus", v: "Consulting · Strategy · PMO · BA" }
    ]
  },
  ...
  projects: {
    ...
    cta: { label: "Try live experiments on the Builds page", href: "builds/" },
    items: [
      {
        icon: "search",
  ...
  contact: {
    ...
    sub: "Open to consulting, Strategy and business analyst roles in the UK, and to freelance project work: web builds, AI and workflow automation, dashboards, video editing.",
