...
const SITE = {
  ...
  toolkit: [
    "RAID & RACI", "Stakeholder comms", "Vendor evaluation", "Workshop facilitation",
    "SteerCo reporting", "Six Sigma Green Belt", "Advanced Excel", "Power BI",
    "MS Project", "Jira", "SharePoint", "Python", "SQL", "Grafana",
  ...
  experience: {
    ...
    gantt: {
      ...
      rows: [
        { org: "GXO Logistics",  sub: "Warehouse Associate",       from: "2025-10", to: "now",     kind: "work",  target: "xp-gxo" },
        { org: "TUI Airlines",   sub: "PM Intern, PMO",            from: "2025-06", to: "2025-09", kind: "work",  target: "xp-tui" },
        { org: "Cranfield",      sub: "MSc Management",            from: "2024-09", to: "2025-10", kind: "study", target: "education" },
        { org: "WSPL",           sub: "Consultant & EA to CEO",    from: "2023-11", to: "2024-09", kind: "work",  target: "xp-wspl" },
        { org: "Infosys",        sub: "System Engineer",           from: "2021-10", to: "2023-09", kind: "work",  target: "xp-infosys" },
        { org: "NMIT Bengaluru", sub: "BE Mechanical Engineering", from: "2018-08", to: "2021-05", kind: "study", target: "education" }
      ]
    },
    roles: [
      {
  ...
  contact: {
    ...
    sub: "Open to consulting, PMO, and business analyst roles in the UK.",
